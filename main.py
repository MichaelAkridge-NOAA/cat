...
Backward compatibility entry point for CATfrom fastapi.responses import HTMLResponse, JSONResponse, FileResponse

Use 'cat-server' command after pip install, or run this file directlyfrom fastapi.staticfiles import StaticFiles

"""from titiler.core.factory import TilerFactory

from cat.cli import mainfrom starlette.middleware.cors import CORSMiddleware

from pathlib import Path

if __name__ == "__main__":from typing import List, Optional, Dict
...
from app.api.coral_species import router as coral_router

# Import file-based project API
from app.api.file_projects import router as file_projects_router
